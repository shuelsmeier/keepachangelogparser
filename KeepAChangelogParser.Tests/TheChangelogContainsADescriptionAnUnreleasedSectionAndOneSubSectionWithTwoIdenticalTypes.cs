...
{
  [TestClass]
  public class TheChangelogContainsADescriptionAnUnreleasedSectionAndOneSubSectionWithTwoIdenticalTypes
  {
    [TestMethod]
    public void WhenTheChangelogContainsADescriptionAnUnreleasedSectionAndOneSubSectionWithTwoIdenticalTypes_ThenTheResultIsFailureSubsectionTypeAlreadyExists()
    {
      // Arrange
      string textToParse =
        createTextToParse();
    ...
    private static string createTextToParse()
    {
      return
        ...
        /* 20 */ "### Added" + Environment.NewLine +
        /* 21 */ "- New visual identity by[@tylerfortune8](https://github.com/tylerfortune8)." + Environment.NewLine +
        /* 22 */ "- Version navigation." + Environment.NewLine +
    ...
    private static Result<Changelog> createExpectedParseResult()
    {
      Result<Changelog> expectedParseResult =
        Result.Failure<Changelog>(
          "Subsection type already exists. Error parsing text in line 20 / index 5.");
