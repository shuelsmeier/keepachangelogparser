...
{
  [TestClass]
  public class TheChangelogContainsADescriptionAnUnreleasedSectionAndTwoSubSectionsWithAsterisks
  {
    [TestMethod]
    public void WhenTheChangelogContainsADescriptionAnUnreleasedSectionAndTwoSubSectionsWithAsterisks_ThenTheResultIsCorrect()
    {
      // Arrange
      string textToParse =
        createTextToParse();
      ...
      Result<Changelog> actualParseResult =
        changelogParser.Parse(
          ...
          {
            ChangelogListHandling = ChangelogListHandling.AllowAsterisk,
          });
