...
{
  [TestClass]
  public class TheChangelogContainsADescriptionAnUnreleasedSectionAndOneSubSectionWithMissingVersion
  {
    [TestMethod]
    public void WhenTheChangelogContainsADescriptionAnUnreleasedSectionAndOneSubSectionWithMissingVersion_ThenTheResultIsFailureInvalidVersion()
    {
      // Arrange
      string textToParse =
        createTextToParse();
    ...
    private static string createTextToParse()
    {
      return
        ...
        /* 14 */ "## [] - 2017-06-20" + Environment.NewLine +
