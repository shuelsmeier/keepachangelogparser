...
{
  [TestClass]
  public class TheChangelogContainsADescriptionAnUnreleasedSectionAndOneSubSectionWithInvalidVersion
  {
    [TestMethod]
    public void WhenTheChangelogContainsADescriptionAnUnreleasedSectionAndOneSubSectionWithInvalidVersion_ThenTheResultIsFailureInvalidVersion()
    {
      // Arrange
      string textToParse =
        createTextToParse();
    ...
    private static string createTextToParse()
    {
      return
        ...
        /* 14 */ "## [1.0] - 2017-06-20" + Environment.NewLine +
    ...
    private static Result<Changelog> createExpectedParseResult()
    {
      Result<Changelog> expectedParseResult =
        Result.Failure<Changelog>(
          "Invalid version. Error parsing text in line 14 / index 5.");
