...
- Fix unreleased section custom changelog sub section types

## [2.0.0] - 2025-11-09

### Fixed

- Fix newline changelog token
...
- Bump ReportGenerator from 5.4.6 to 5.4.17
- Bump Roslynator.Analyzers from 4.13.1 to 4.14.1
- Bump Roslynator.CodeAnalysis.Analyzers from 4.13.1 to 4.14.1
- Bump Roslynator.Formatting.Analyzers from 4.13.1 to 4.14.1

## [1.2.8] - 2025-10-11

### Fixed

- Fix # characters in text (#194)

### Changed
- Bump MSTest.TestAdapter from 3.8.2 to 3.8.3
- Bump MSTest.TestFramework from 3.8.2 to 3.8.3
- Bump ReportGenerator from 5.4.4 to 5.4.6
- CSharpFunctionalExtensions from 3.5.1 to 3.6.0
